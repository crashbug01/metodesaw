...
<head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('assetadmin/css/adminlte.css ')}}" />
        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Tabel Alternatif</h3>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                <li class="breadcrumb-item">
                                    <a href="/tabel-alternatif">Tabel Alternatif</a>
                                </li>
                                    ...
                                    <tbody>
                                        @foreach ($alternatif as $alternatif)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('alternatif.editalternatif', $alternatif->id_alternatif) }}"
                                                        class="btn btn-warning">Edit</a>
                                                </td>
                                                <td>
                                                    <form method="POST"
                                                        action="{{ route('alternatif.destroyalternatif', $alternatif->id_alternatif) }}">
                                                        @csrf
                                                        @method('DELETE')
