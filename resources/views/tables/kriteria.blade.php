        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Tabel Kriteria</h3>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                <li class="breadcrumb-item">
                                    <a href="/tabel-kriteria">Tabel Kriteria</a>
                                </li>
                                    ...
                                    <tbody>
                                        @foreach ($kriteria as $kriteria)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('kriteria.editkriteria', $kriteria->id_kriteria)}}"
                                                        class="btn btn-warning btn-xs">Edit</a>
                                                </td>
                                                <td>
                                                    <form method="POST"
                                                        action="{{ route('kriteria.destroykriteria', $kriteria->id_kriteria) }}">
                                                        @csrf
                                                        @method('DELETE')
