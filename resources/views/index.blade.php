...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('assetadmin/css/adminlte.css ')}}" />
                        ...
                        <div class="card card-primary card-outline mb-4">
                            <div class="card-header">
                                ...
                                <div class="card-title text-center">
                                    <h3>Sistem Pengambil Keputusan Rumah Kontrakan</h3>
                                </div>
                            </div>
                        </div>
                                <div class="card-body align-text">
                                    <div class="row">
                                    <p>Selamat datang di Sistem Pendukung Keputusan Pemilihan Rumah Kontrakan. Sistem ini dirancang untuk membantu pengguna dalam menentukan pilihan rumah kontrakan terbaik berdasarkan kriteria tertentu menggunakan metode Simple Additive Weighting. Data alternatif mencakup daftar rumah kontrakan yang tersedia, sementara kriteria dapat disesuaikan dengan kebutuhan pengguna. Sistem ini memanfaatkan bobot dan sifat masing-masing kriteria untuk melakukan perhitungan normalisasi dan menghasilkan peringkat alternatif terbaik sesuai kebutuhan pengguna. Dengan tampilan yang sederhana dan interaktif, sistem ini diharapkan dapat memberikan solusi yang efisien dan akurat dalam pengambilan keputusan.</p>
                                </div>
                                </div>
                        </div>
                    </div>
