                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                <li class="breadcrumb-item">
                                    <a href="/form-kriteria">Form Kriteria</a>
                                </li>
            ...
            <div class="app-content">
                ...
                <div class="container-fluid">
                    <div class="card card-primary card-outline mb-4">
                        ...
                        <form method="POST" action="{{ route('kriteria.storekriteria') }}">
                            <div class="card-body">
                                <div class="mb-3">
                                    @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sifat" id="cost"
                                                value="cost" checked />
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sifat" id="benefit"
                                                value="benefit" />
